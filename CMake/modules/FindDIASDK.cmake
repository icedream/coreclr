...
if((NOT "${VSINSTALLDIR}" MATCHES "-NOTFOUND$") AND (EXISTS "${DIASDK_DIR}"))
	...
	find_path(DIASDK_IDL_DIR NAMES "dia2.idl"
		HINTS "${VSINSTALLDIR}/DIA SDK/idl")

	find_library(DIASDK_LIBRARY_DIAGUIDS NAMES diaguids
		HINTS "${VSINSTALLDIR}/DIA SDK")
	...
	set(DIASDK_LIBRARIES "${DIASDK_LIBRARY_DIAGUIDS}")
	...
	set(DIASDK_LIBRARY "DIASDK_LIBRARY-NOTFOUND")
	set(DIASDK_IDL "DIASDK_IDL-NOTFOUND")
...
find_package_handle_standard_args(DIASDK DEFAULT_MSG DIASDK_DIR DIASDK_LIBRARY_DIAGUIDS DIASDK_INCLUDE_DIR)
